// lucide-react não inclui mais ícones de marca. Ícones mínimos e leves,
// desenhados como outline para combinar com o restante do set (Lucide, thin/light).
...
export function LinkedinIcon({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
    ...
    >
      ...
      <path d="M11.5 16.5v-6M11.5 12.2c0-1 .9-1.7 2-1.7s2 .7 2 2v3.9" />
    </svg>
  );
}
